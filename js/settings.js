...
function exportUserTheme() {
    var theme = {
        ...
        searchWidth: localStorage.getItem(STORAGE_KEYS.SEARCH_WIDTH) || DEFAULTS.SEARCH_WIDTH,
        searchX: localStorage.getItem(STORAGE_KEYS.SEARCH_X) || DEFAULTS.SEARCH_X,
        searchY: localStorage.getItem(STORAGE_KEYS.SEARCH_Y) || DEFAULTS.SEARCH_Y,
        favX: localStorage.getItem(STORAGE_KEYS.FAV_X) || DEFAULTS.FAV_X,
        favY: localStorage.getItem(STORAGE_KEYS.FAV_Y) || DEFAULTS.FAV_Y,
        favLayout: localStorage.getItem(STORAGE_KEYS.FAV_LAYOUT) || DEFAULTS.FAV_LAYOUT,
